...
public class FormValidator {
    ...
    public static String validateField1(Field field, Object value){
    ...
    public static List<String> validateField(Field field, Object value){
    ...
    private static void validateMin(Field field, Object value, int minValue) throws ValidationException {
        ...
        if(value instanceof Number){
            ...
            double valeur = Double.parseDouble(value.toString());
            if(valeur < minValue){
                throw new ValidationException((field.getName() + " must be greater than or equal to " + minValue));    
            }
        }
